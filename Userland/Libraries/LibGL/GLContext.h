...
private:
    ...
    struct Listing {
        ...
        using FunctionsAndArgs = FunctionAndArgs<
            void (GLContext::*)(),
            void (GLContext::*)(Matrix<4, float> const&),
            void (GLContext::*)(double, double),
            void (GLContext::*)(double, double, double, double),
            void (GLContext::*)(double, double, double, double, double, double),
            void (GLContext::*)(float),
            void (GLContext::*)(float, float),
            void (GLContext::*)(float, float, float),
            void (GLContext::*)(float, float, float, float),
            void (GLContext::*)(int),
            void (GLContext::*)(int, int, float, float, float, float, unsigned char const*),
            void (GLContext::*)(int, int, int, int),
            void (GLContext::*)(int, int, unsigned int, unsigned int, void const*),
            void (GLContext::*)(int, unsigned int, void const*),
            void (GLContext::*)(unsigned char),
            void (GLContext::*)(unsigned int),
            void (GLContext::*)(unsigned int, double const*),
            void (GLContext::*)(unsigned int, float const*),
            void (GLContext::*)(unsigned int, float),
            void (GLContext::*)(unsigned int, float, float, float, float),
            void (GLContext::*)(unsigned int, int),
            void (GLContext::*)(unsigned int, int, int, int, int, int, int, int),
            void (GLContext::*)(unsigned int, int, unsigned int, int, int, int, int, int),
            void (GLContext::*)(unsigned int, unsigned int),
            void (GLContext::*)(unsigned int, unsigned int, Gfx::VectorN<4, float>),
            void (GLContext::*)(unsigned int, unsigned int, float const*),
            void (GLContext::*)(unsigned int, unsigned int, float),
            void (GLContext::*)(unsigned int, unsigned int, float, float, float, float),
            void (GLContext::*)(unsigned int, unsigned int, int const*),
            void (GLContext::*)(unsigned int, unsigned int, int),
            void (GLContext::*)(unsigned int, unsigned int, int, unsigned int),
            void (GLContext::*)(unsigned int, unsigned int, unsigned int, unsigned int),
            void (GLContext::*)(unsigned int, unsigned int, void*, unsigned int)>;
