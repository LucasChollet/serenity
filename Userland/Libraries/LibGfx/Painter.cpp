...
void Painter::draw_physical_pixel(IntPoint const& physical_position, Color color, int thickness, Optional<NonnullRefPtr<Layer>> layer)
{
...
void Painter::draw_line(IntPoint const& a_p1, IntPoint const& a_p2, Color color, int thickness, LineStyle style, Color alternate_color, Optional<NonnullRefPtr<Layer>> layer)
{
    if (thickness <= 0)
        return;
