...
int RoundingDialog::show(GUI::Window* parent_window, StringView title, unsigned& rounding_value)
{
    ...
    dialog->m_text_editor->set_text(String::formatted("{}", rounding_value));
