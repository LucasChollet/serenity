...
class JsonValue;
class LexicalPath;
using LittleEndianInputBitStream = Detail::LittleEndianInputBitStreamImpl<Detail::RefillPolicy::NoRefill>;
using InfiniteLittleEndianInputBitStream = Detail::LittleEndianInputBitStreamImpl<Detail::RefillPolicy::FillWithZeroes>;
...
using AK::HashMap;
using AK::HashTable;
using AK::InfiniteLittleEndianInputBitStream;
